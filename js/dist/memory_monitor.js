class MemoryMonitor {
    constructor(memory, cpu) {
        ...
        //CPU Flags
        this.n_flag = document.getElementById("n-flag");
        this.v_flag = document.getElementById("v-flag");
        this.b_flag = document.getElementById("b-flag");
        this.d_flag = document.getElementById("d-flag");
        this.i_flag = document.getElementById("i-flag");
        this.z_flag = document.getElementById("z-flag");
        this.c_flag = document.getElementById("c-flag");
        //Monitor table
    ...
    update_memory_monitor(startAddr) {
